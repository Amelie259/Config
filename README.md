...
il suffit d'exécuter la commande apres avoir ouvrir le dossier Extracteur_Meteo_Projet : ./Extracteur_Meteo.sh suivie du nom d'une ville, par exemple ./Extracteur_Meteo.sh Paris.
